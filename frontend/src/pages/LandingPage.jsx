...
const features = [
  ...
  { icon: '🛡️', title: 'Forest Command', desc: 'Advanced command center with GIS maps and AI copilot.', path: '/forest-command' },
  ...
  { icon: '🏕️', title: 'Tourist Safety', desc: 'Zone-based safety scores for Gir and Girnar visitors.', path: '/tourist' },
